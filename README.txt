...
Run python3 check_length.py 
This prints the number of observations in each parquet file.

Run python3 run_preprocessing.py
...
Run python3 split_found_objects.py
...
Run python3 search_NEA_MBO.py comments out the asteroids that are neither NEAs nor MBOs in choose_physical.txt and choose_lsm.txt.

Run python3 run_physical_properties_batch.py to run the wrapper Asteroid_physical_properties.py for the objects in choose_physical.txt.

Run python3 run_LSM.py to run the wrapper Asteroid_LSM.py for the objects in choose_lsm.txt.
